    ...
    <div>
      <Card className="mb-6 mt-8">
        <CardHeader className="flex items-center justify-between">
          <CardTitle>
            Jumlah Penduduk Berumur 7-23 Tahun ke Atas Menurut Jenis Kelamin dan
            Status Pendidikan di Desa Kapuak, 2025 (Grafik)
          </CardTitle>
      ...
      <Card>
        <CardHeader className="flex items-center justify-between">
          <CardTitle>
            Jumlah Penduduk Berumur 7-23 Tahun ke Atas Menurut Jenis Kelamin dan
            Status Pendidikan di Desa Kapuak, 2025 (Tabel)
          </CardTitle>
